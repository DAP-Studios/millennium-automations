            ...
            <div className="bg-white/10 backdrop-blur-md border-2 border-white/30 rounded-xl p-2 sm:p-3 md:p-4 flex-1">
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div className="flex-1">
                  <a
                    href="https://maps.app.goo.gl/oFKGh4wFHM1XgRtt5"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  >
                    6A,first floor, Globe Chamber, Via Char Rasta Rd, opp. Sardar bhiladwala bank, Phase 2, GIDC, Vapi, Gujarat 396195
                  </a>
                </div>
              </div>
            </div>
