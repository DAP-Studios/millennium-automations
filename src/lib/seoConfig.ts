...
export const defaultSEO: SEOProps = {
  title: "Authorized Delta Electronics Distributor in Vapi | Industrial Automation Solutions",
  description: "Authorized Delta Electronics distributor in Vapi, Gujarat. ME300, MS300, DVP-ES3, ASDA-H3, TP70P series. Expert industrial automation solutions: VFD, PLC, HMI, Servo Systems. 24/7 support. Get quote now.",
