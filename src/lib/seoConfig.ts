...
export const SITE_CONFIG = {
  ...
  location: {
    ...
    state: "Gujarat",
    country: "India",
    fullAddress: "6A,first, Globe Chamber, Via Char Rasta Rd, opp. Sardar bhiladwala bank, Phase 2, GIDC, Vapi, Gujarat 396195"
  },
  contact: {
    phone: "+91-9904003445",
...
export const getAllKeywords = (): string => {
  const baseKeywords = [
    // Local Industrial Search Terms (Vapi)
    "Vapi (Local Industrial Search Terms)",
    "Delta dealer Vapi",
    ...
    "Delta Servo motor dealer Vapi",
    "Delta SMPS dealer Vapi",
    "Delta PSU supplier Vapi",
    "Delta temp controller Vapi",
    "Delta TC dealer Vapi",
    "Delta automation Vapi",
    "Delta ind. automation Vapi",
    "Delta auth. dealer Vapi",
    "Delta channel partner Vapi",
    "Buy Delta VFD Vapi",
    "Delta VFD price Vapi",

    // Gujarat State-Level Keywords
    "Delta Electronics Gujarat",
    "Delta dealer Gujarat",
    "Delta distributor Gujarat",
    "Delta VFD Gujarat",
    "Delta PLC Gujarat",
    "Delta HMI Gujarat",
    "Delta Servo Gujarat",
    "Delta AC drive Gujarat",
    "Delta automation Gujarat",
    "Delta ind. supplier Gujarat",
    "Delta auth. distributor Gujarat",
    "Delta stockist Gujarat",
    "Delta control panel Gujarat",
    "Delta drive supplier Gujarat",

    // Industrial Buyer Short-Form Keywords (Common in India)
    "VFD dealer Vapi",
    "PLC supplier Vapi",
    "HMI dealer Vapi",
    "AC drive supplier Gujarat",
    "Servo drive dist. Gujarat",
    "Ind. automation dealer Vapi",
    "Automation products Gujarat",
    "Elec. automation Vapi",
    "Industrial control supplier Vapi",
    "Drive & PLC dealer Gujarat",

    // High-Intent Commercial Keywords (Indian Search Style)
    "Best Delta VFD dealer in Vapi Gujarat",
    "Delta PLC supplier near me",
    "Delta VFD price in Gujarat",
    "Authorized Delta distributor Gujarat",
    "Delta automation products Vapi",
